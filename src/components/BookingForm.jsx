    ...
    <section className="hallbooking">
      ...
      <form onSubmit={handleSubmit} className="hallbooking-form">
        <div className="hallbooking-form-left hallbooking-form-comdent">
          ...
          <div className="input-container">
            <label className="text">Enter your Department</label>
          ...
          <div className="input-container">
            <label className="text">Enter your phone no</label>
          ...
          <div className="input-container">
            <label className="text">Enter your Event Details</label>
        ...
        <div className="hallbooking-form-right hallbooking-form-comdent">
          <div className="input-container">
            <label className="text">Enter Event start date</label>
            <input type="datetime-local" className="input-box" value={event_start} onChange={(e) => setEventStart(e.target.value)} required />
          </div>
          <div className="input-container">
            <label className="text">Enter Event end date</label>
            <input type="datetime-local" className="input-box" value={event_end} onChange={(e) => setEventEnd(e.target.value)} required />
          </div>
          <div className="input-container">
            <label className="text">Enter Event booking date</label>
            <input type='datetime-local' id='datetime' className="input-box" value={booking_date} readOnly required />
          </div>
          <div className="input-container">
            <label className="text">Enter your Gmail</label>
            <input type="email" placeholder='Example@gmail.com' className="input-box" value={email} onChange={(e) => setEmail(e.target.value)} required />
          </div>
        </div>
        <button type="submit" className='booking-btn'>Book Hall</button>
      </form>
    </section>
  );
}
